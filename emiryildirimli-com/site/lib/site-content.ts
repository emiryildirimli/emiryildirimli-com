...
export const rows: Block[] = [
  ...
  [
    ...
    "— mostly in the",
    { text: "Turkish market," },
    "where the network I've built actually",
    { text: "moves numbers." },
  ],
  [
  ...
  [
    ...
    { text: "Pow Ahoy" },
    "didn't launch: the market turned before we did. I still think it's the",
    { text: "biggest idea" },
    "I have, and I'm",
    { text: "building it" },
    "for the right cycle.",
  ...
  [
    "When people ask what I do for fun, the honest answer is",
    { text: "this:" },
    { text: "charts," },
    { text: "launch days," },
    "and watching a",
